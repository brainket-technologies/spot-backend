...
class VendorController extends Controller
{
    public function get_profile(Request $request)
    {
        ...
        $vendor['subscription_transactions'] = (bool) SubscriptionTransaction::where('restaurant_id', $restaurant->id)->count() > 0 ? true : false;
    ...
    public function get_current_orders(Request $request)
    {
        ...
        // $orders2 = Order::whereRelation('restaurant.vendor', 'id', $vendor->id)->get();
        // return response()->json(['message'=> 'Test', $orders2], 200);
        $vendor = $request['vendor'];
        ...
        // $orders2 = Order::whereRelation('restaurant.vendor', 'id', $vendor->id)->get();
        // return response()->json(['message'=> 'Test', $orders2], 200);
        // return response()->json($orders2, 200);

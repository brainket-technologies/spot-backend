...
<head>
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.login') }} | {{$app_name??translate('spot2delivery')}}</title>
...
<main id="content" role="main" class="main auth-bg">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between">
        <div class="auth-content">
            <div class="content">
                <h2 class="title text-uppercase">{{translate('messages.welcome_to')}} {{ $app_name??'spot2delivery' }}</h2>
                <p>
